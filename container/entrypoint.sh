...
# Project Ovine container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping project-ovine..."
...
# Examples:
#   exec /app/project-ovine
#   exec /app/release/bin/project-ovine start
#   exec /app/project-ovine serve --host "${APP_HOST}" --port "${APP_PORT}"
