...
= Contributing — Project Ovine
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Project Ovine`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/Project Ovine.git
cd Project Ovine
...
* Bugs in `Project Ovine`: file at `metadatastician/Project Ovine/issues`.
