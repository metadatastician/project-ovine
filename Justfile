...
build *args:
    @echo "Building project_ovine (debug)..."
...
build-release *args:
    @echo "Building project_ovine (release)..."
...
cookbook:
    ...
    echo "= project_ovine Justfile Cookbook" > "$OUTPUT"
...
man:
    #!/usr/bin/env bash
    mkdir -p docs/man
    cat > docs/man/project_ovine.1 << EOF
    .TH project_ovine 1 "$(date +%Y-%m-%d)" "{{version}}" "project_ovine Manual"
    .SH NAME
    project_ovine \- RSR-compliant project
    .SH SYNOPSIS
    .B just
    [recipe] [args...]
    .SH DESCRIPTION
    ...
    EOF
    echo "Generated: docs/man/project_ovine.1"
...
doctor:
    @echo "Running diagnostics for project-ovine..."
...
help-me:
    @echo "=== project-ovine Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/metadatastician/project-ovine/issues/new"
    @echo ""
