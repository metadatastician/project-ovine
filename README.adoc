...
image:https://api.scorecard.dev/projects/github.com/metadatastician/project-ovine/badge[OpenSSF Scorecard,link="https://scorecard.dev/viewer/?uri=github.com/metadatastician/project-ovine"]
image:https://sonarcloud.io/api/project_badges/measure?project=metadatastician_project-ovine&metric=alert_status[SonarQube Quality Gate,link="https://sonarcloud.io/summary/new_code?id=metadatastician_project-ovine"]
image:https://archive.softwareheritage.org/badge/origin/https://github.com/metadatastician/project-ovine/[Archived in Software Heritage,link="https://archive.softwareheritage.org/browse/origin/?origin_url=https://github.com/metadatastician/project-ovine"]
