...
1. Navigate to [Report a Vulnerability](https://github.com/metadatastician/project-ovine/security/advisories/new)
...
- This repository (`metadatastician/project-ovine`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/metadatastician/project-ovine/security/advisories)
...
When using Project Ovine, we recommend:
...
- [Security Advisories](https://github.com/metadatastician/project-ovine/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/metadatastician/project-ovine/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/metadatastician/project-ovine/discussions) |
...
*Thank you for helping keep Project Ovine and its users safe.* 🛡️
