...
// Replace project-ovine, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= project-ovine — Quick Start for Users
:toc:
:toclevels: 2
...
[source,bash]
----
just install --portable --prefix=./project-ovine-portable
----
...
* **Wiki**: https://github.com/metadatastician/project-ovine/wiki
